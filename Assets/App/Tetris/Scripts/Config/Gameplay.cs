...
namespace Tetris
{
    ...
    public class Gameplay : GlobalConfig<Gameplay>
    {
        ...
        public Gameplay New( BlockSpawner spawner )
        {
        ...
        public Gameplay New( BlockSpawner spawner, TetrisVFX tetrisVFX )
        {
            this.New( spawner );
            this.m_TetrisVFX = tetrisVFX;
            return this;
        }
        ...
        public void NextBlock()
        {
            ...
            if ( !currentBlock.MoveDown() ) {
                foreach ( Transform child in currentBlock.transform ) {
                    var x = Utils.Float2Int( child.transform.position.x );
                    var y = Utils.Float2Int( child.transform.position.y );
                    if ( Grid[x, y] != null ) {
                        OnGameOver?.Invoke();
                        gameOver = true;
                        currentBlock = null;
    ...
    #region Block Control
        ...
        public void HoldBlock()
        {
            ...
            if ( holded != null ) {
                ...
                currentBlock = holded;
                holded = tmp;
                currentBlock.transform.position = new Vector3( Gameplay.Width / 2, Gameplay.Height );
            ...
            m_TetrisVFX?.PlayClip( Utils.ClipHold );
        ...
        public void MoveRight()
        {
            ...
            if ( currentBlock.MoveRight() ) {
                landedWithRotate = false;
                lastWaitTime = 0;
                m_TetrisVFX?.PlayClip( Utils.ClipMove );
                UpdatePreview();
            }
        }
        ...
        public void ClockwiseRotation()
        {
            ...
            if ( currentBlock.ClockwiseRotation() ) {
                ...
                lastWaitTime = 0;
                m_TetrisVFX?.PlayClip( Utils.ClipRotate );
                UpdatePreview();
            }
        }
        ...
        public void HardDrop()
        {
            ...
            landed = true;
            if ( m_TetrisVFX ) {
                m_TetrisVFX.VFX_HardDrop( currentBlock.transform.position );
                m_TetrisVFX.PlayClip( Utils.ClipHardDrop );
            }
        }
            ...
            if ( !landed ) {
                if ( !isLanding ) {
                    ...
                    if ( lastWaitTime >= waitLandTime ) {
                        landed = true;
                        lastWaitTime = 0;
                        m_TetrisVFX?.PlayClip( Utils.ClipSoftDrop );
                    }
                    else {
                        isLanding = !currentBlock.MoveDown();
                ...
                m_TetrisVFX?.PlayClip( Utils.ClipLanding );
                DestroyPreview();
                AddToGrid();
                if ( gameOver ) return;
                Check();
        ...
        private void Check()
        {
            ...
            for ( int i = m_rows.Count - 1; i >= 0; i-- ) {
                if ( !HasLine( m_rows[i] ) ) {
                    ...
                    m_TetrisVFX.VFX_LineClear( m_rows[i] );
                }
            }
    ...
    #region Block Preview
        ...
        {
            m_preview = GameObject.Instantiate( currentBlock, Game.instance.transform );
            ...
            if ( isTSpin ) {
                if ( isMini ) {
                    switch ( count ) {
                        case 1:
                            points = 200 * level;
                            m_TetrisVFX.TextVFX_TSpinMiniSingle();
                            break;
                        case 2:
                            points = 1200 * level;
                            m_TetrisVFX.TextVFX_TSpinMiniDouble();
                            break;
                        default:
                            break;
                    }
                    ...
                    switch ( count ) {
                        case 1:
                            points = 800 * level;
                            m_TetrisVFX.TextVFX_TSpinSingle();
                            break;
                        case 2:
                            points = 1200 * level;
                            m_TetrisVFX.TextVFX_TSpinDouble();
                            break;
                        case 3:
                            points = 1600 * level;
                            m_TetrisVFX.TextVFX_TSpinTriple();
                            break;
                        default:
                            break;
                    }
                ...
                m_TetrisVFX.PlayClip( Utils.ClipSpecial );
            }
            else {
                switch ( count ) {
                    case 1:
                        points = 100 * level;
                        m_TetrisVFX.PlayClip( Utils.ClipSingle );
                        break;
                    case 2:
                        points = 300 * level;
                        m_TetrisVFX.PlayClip( Utils.ClipDouble );
                        break;
                    case 3:
                        points = 500 * level;
                        m_TetrisVFX.PlayClip( Utils.ClipTriple );
                        break;
                    case 4:
                        points = 800 * level;
                        m_TetrisVFX.PlayClip( Utils.ClipTetris );
                        m_TetrisVFX.TextVFX_Tetris();
                        break;
                    default:
                        break;
                }
