...
namespace Tetris
{
    ...
    {
        private Block.Block[] m_bag;
        private LinkedList<Block.Block> m_next = new LinkedList<Block.Block>();
        private LinkedList<Block.Block> m_next_view = new LinkedList<Block.Block>();

        public BlockSpawner(Block.Block[] blocks)
        {
            m_bag = blocks;
            // two bags
            RandomGenerator();
        ...
        {
            LinkedListNode<Block.Block> head = m_next.First;
        ...
        public void UpdateNextChainSlot(int count = 5)
        {
            ...
            // view list - head node
            LinkedListNode<Block.Block> head2 = m_next_view.First;
            // next list - head node
            LinkedListNode<Block.Block> head = m_next.First;
