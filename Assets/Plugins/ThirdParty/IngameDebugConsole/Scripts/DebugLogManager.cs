...
#pragma warning restore 0649
		...
		private void Awake()
		{
            ...
            //popupManager.GetComponent<RectTransform>().offsetMin = new Vector2(-20f,0f);
        }
		...
		private void Update()
		{
            ...
            // fix:mo
            var isSearchFocused = searchbar.GetComponentInChildren<InputField>().isFocused;

            filterErrorButton.gameObject.SetActive(!isSearchFocused);
            filterInfoButton.gameObject.SetActive(!isSearchFocused);
            filterWarningButton.gameObject.SetActive(!isSearchFocused);
            // fix:end
		}
    ...
    if (queuedLogEntries == null) return;
