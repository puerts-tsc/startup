...
//                        continue; // 忽略重复的类
//                    if(excludes.Any(t => $"{type.FullName}".Contains(t) ) || Puerts.Filter.IsExcluded(type)) 
//                        continue; // 忽略列表
//                    bool accept = namespaces.Contains(type.Namespace) ||
//                        namespaces.Any(t => type.Namespace.StartsWith(t + ".")) ||
//                        assembly.GetName().Name.Contains("Assembly-CSharp");
...
//            types.Add( typeof(JsMain) );
//            //types.Add( typeof(TsProxy) );
//
//            // TODO: 添加需要导出声明的类型
//            return types;
//            
...
//        }
//
//        var className = memberInfo.ReflectedType.FullName ?? "";
//   
//        if (excludes.Any(t => $"{className}.{memberInfo.Name}".Contains(t))) {
//            return true;
//        }
//
...
//
//    //[CodeOutputDirectory]
//    //static string CodeOutputPath => UnityEngine.Application.dataPath + "/Plugins/Puerts/Gen/";
//}