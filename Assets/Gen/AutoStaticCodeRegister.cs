namespace PuertsStaticWrap
{
    public static class AutoStaticCodeRegister
    {
        public static void Register(Puerts.JsEnv jsEnv)
        {
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ExtensionsToggle), UnityEngine_UI_ExtensionsToggle_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ExtensionsToggleGroup), UnityEngine_UI_ExtensionsToggleGroup_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ReturnKeyTriggersButton), UnityEngine_UI_ReturnKeyTriggersButton_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ExtensionsToggle.ToggleEvent), UnityEngine_UI_ExtensionsToggle_ToggleEvent_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ExtensionsToggle.ToggleEventObject), UnityEngine_UI_ExtensionsToggle_ToggleEventObject_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.UI.ExtensionsToggleGroup.ToggleGroupEvent), UnityEngine_UI_ExtensionsToggleGroup_ToggleGroupEvent_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.AssetReferenceUIRestriction), UnityEngine_AssetReferenceUIRestriction_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityEngine.AssetReferenceUILabelRestriction), UnityEngine_AssetReferenceUILabelRestriction_Wrap.GetRegisterInfo);
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(SandBox.TestJs), SandBox_TestJs_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(Examples.Node_tsc.UIEvent), Examples_Node_tsc_UIEvent_Wrap.GetRegisterInfo);
